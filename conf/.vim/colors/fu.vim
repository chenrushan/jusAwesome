...
" General colors
hi Normal         ctermfg=255   ctermbg=234                  guifg=#d0d0d0  guibg=#1c1c1c
...
hi TabLine        ctermfg=253   ctermbg=237   cterm=None     guifg=#dadada  guibg=#3a3a3a
hi TabLineFill    ctermfg=0     ctermbg=239   cterm=None     guifg=#000000  guibg=#000000
hi TabLineSel     ctermfg=255   ctermbg=33                   guifg=#eeeeee  guibg=#0087ff
hi VertSplit      ctermfg=24   ctermbg=253                  guifg=#3a3a3a  guibg=#3a3a3a
hi Visual         ctermfg=24    ctermbg=153                  guifg=#005f87  guibg=#afd7ff
hi VIsualNOS      ctermfg=24    ctermbg=153                  guifg=#005f87  guibg=#afd7ff
hi LineNr         ctermfg=248   ctermbg=233                  guifg=#a8a8a8  guibg=#080808
...
hi PreProc 		    ctermfg=172                                guifg=#ffffaf
