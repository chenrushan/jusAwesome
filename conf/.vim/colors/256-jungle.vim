...
hi Normal	    ctermfg=256         ctermbg=None        cterm=None
...
hi Identifier	ctermfg=178         ctermbg=None        cterm=Bold
...
hi StatusLineNC ctermfg=248         ctermbg=black         cterm=Bold
hi StatusLine   ctermfg=39          ctermbg=black         cterm=Bold
hi VertSplit    ctermfg=239         ctermbg=239         cterm=None

hi TabLine      ctermfg=245         ctermbg=239         cterm=None
hi TabLineFill  ctermfg=239         ctermbg=239         cterm=None
hi TabLineSel   ctermfg=39         ctermbg=236         cterm=Bold
